...
public class LinkedListTest {
	...
	public void testAddIntE() {
		...
		assertNull(list.getLastElement());
		list.add(0, "apple");
		assertEquals(1, list.size());
		assertEquals("apple", list.get(0));
		assertEquals("apple", list.getLastElement());
		...
		assertEquals(list.getLastElement(), "snickers");
	...
	/**
	 * Tests adding elements at end of linkedlist
	 */
	@Test
	...
	public void testRemoveInt() {
		...
		list.add(0, "orange");
		list.add(1, "banana");
		assertEquals("banana", list.getLastElement());
		list.add(2, "apple");
		list.add(3, "kiwi");
		assertEquals(4, list.size());
		assertEquals("orange", list.get(0));
		...
		assertEquals("kiwi", list.getLastElement());
